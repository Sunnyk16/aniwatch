    ...
    <div className="container">
      <div className="row mx-2 my-3">
        <div className="col-md-2 col-sm-4 col-6">
          <div className="w-100 h-75 p-2 bg-light d-flex flex-row justify-content-center">
        ...
        <div className="col-md-2 col-sm-4 col-6">
          <div className="w-100 p-2 h-75 bg-light d-flex flex-row justify-content-center">
